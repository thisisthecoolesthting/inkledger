---
title: '7. Canon''s "low yield" starter cartridges: what you actually get'
site: inkledger
...
subtopic: cartridges
publishedAt: '2026-05-12T05:48:50Z'
metaDescription: "Analysis of Canon low-yield starter cartridges: page yield data, cost per page, and what you actually get."
excerpt: "Canon starter cartridges ship with lower yields than replacement cartridges. This analysis covers what you actually get and how it affects cost per page."
---
...
1. **Plan ahead:** Know the starter cartridges have low yield. Expect to purchase standard cartridges soon after setup.
2. **Calculate cost per page:** Don’t just look at cartridge price—divide by yield for true ink cost.
3. **Use third-party compatibles cautiously:** Check reviews and compatibility, avoid cheap no-name brands.
4. **Consider refills if confident:** Find reputable refill services familiar with Canon cartridges.
5. **Keep firmware updated:** Canon may issue updates that affect cartridge recognition and refilling.
6. **Recycle cartridges responsibly:** Many third-party programs accept used OEM cartridges.
