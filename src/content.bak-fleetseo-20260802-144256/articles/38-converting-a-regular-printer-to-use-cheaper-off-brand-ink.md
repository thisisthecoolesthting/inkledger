---
title: 38. Converting a regular printer to use cheaper off-brand ink
site: inkledger
...
subtopic: cartridges
publishedAt: '2026-05-12T08:27:32Z'
metaDescription: "Expert analysis of 38. Converting a regular printer to use cheaper off-brand ink. Practical guidance, real data, and honest recommendations."
excerpt: "Many printer owners find themselves frustrated when faced with high brand-name ink cartridge costs that can quickly exceed the price of a new printer. If you’re tired of paying sky-high prices for original equipment manufacturer (OEM) cartridges, con"
---
...
| Cartridge Type        | Approximate Cost Per Cartridge | Estimated Page Yield | Cost Per Page (CPP) | Reliability (Print Quality + Error Rates)                   | Risk of Chip Lockouts/Errors            |
|----------------------|-------------------------------|---------------------|---------------------|-------------------------------------------------------------|----------------------------------------|
| Brand-Name OEM       | High ($30-$70)                 | High (250-500 pages) | Moderate ($0.10-0.20) | High — designed specifically for your printer                | Very low                               |
| Compatible Cartridge | Low ($10-$30)                  | Medium-High (200-400)| Low ($0.05-0.15)    | Good—varies by brand and model; some quality variation       | Moderate: sometimes chip error possible|
| Remanufactured       | Low ($8-$25)                   | Medium (150-350)     | Low ($0.06-0.16)    | Moderate—depending on remanufacturer quality                  | Moderate to high; chip replacement often needed    |
| DIY Refill Kits      | Very Low ($3-$10 per bottle)  | Depends on refill volume | Very low ($0.02-0.08) | Variable; requires skill; more risk of clogs and smudges      | High; no chip reset, may trigger errors |
...
| Factor                 | Using OEM Ink                   | Using Off-Brand/Compatible Ink         |
|------------------------|--------------------------------|----------------------------------------|
| Cost per page          | Higher (~$0.10-0.20)            | Lower (~$0.02-0.15)                     |
| Print quality          | Consistent, manufacturer guaranteed | Generally good, some variation          |
| Reliability            | High, minimal errors            | Varies; some cartridges may fail or clog|
| Firmware compatibility | Guaranteed                     | May be blocked by updates or chip locks|
| Warranty impact        | No impact                      | Potentially voids printer warranty      |
| Convenience            | Plug & play                    | Setup involved, monitor for issues      |
| Environmental impact   | Recyclable OEM cartridges     | Depends on third-party cartridge reuse or refill |
