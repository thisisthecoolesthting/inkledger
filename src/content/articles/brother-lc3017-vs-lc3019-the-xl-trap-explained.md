...
|---------------|--------------------------|--------------------------------|---------------------|---------------------------|
| LC3017        | ~12 ml (varies by color) | ~300 pages per color            | $12–$20             | Standard capacity          |
| LC3019 (XL)   | ~20–25 ml (varies)        | ~550–600 pages per color        | $18–$30             | True XL cartridge          |
...
|-------------------------|--------------------------------|---------------------------------|
| Ink Volume              | Standard                       | XL (typically double volume)    |
| Page Yield              | Lower                         | Higher                          |
| Price                   | Lower upfront                 | Higher upfront, better value per page |
| Compatibility           | Most Brother printers         | Depends on printer model        |
| Risk of “XL trap”       | Low                          | Moderate — check carefully       |
