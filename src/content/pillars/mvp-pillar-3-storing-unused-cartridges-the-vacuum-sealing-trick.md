...
1. **Remove Excess Ink**
   Gently wipe the printhead with a microfiber cloth to prevent cross-contamination

2. **Double-Bag Protection**
   Place cartridge inside two vacuum bags (nested) to prevent puncture leaks

3. **Partial Vacuum Technique**
   Stop the vacuum cycle when bags are 80% compressed - full vacuum can damage ink reservoirs
