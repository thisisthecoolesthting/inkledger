...
/** Slug used in public/images/products/{slug}.jpg when present at build time. */
export function localProductImagePath(slug: string): string {
  return `/images/products/${slug}.jpg`;
}

/** Legacy Amazon image endpoint — still resolves for many ASINs when /images/I/ ids rot. */
